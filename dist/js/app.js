...
(() => {
        ...
        e.exports = (function () {
          ...
          var t = "undefined" != typeof window,
            ...
            Z = function (e, t, i) {
              M(e, t.class_loading),
                T(e, m),
                i && (A(i, 1), P(t.callback_loading, e, i));
            },
            U = function (e, t, i) {
  ...
  (() => {
    ...
    window.addEventListener("load", function (e) {
      ae(),
        document.querySelector(".stats__body") &&
          new ne(".stats__body", {
            modules: [oe, re],
            observer: !0,
            observeParents: !0,
        ...
        return (
          ...
          (e.prototype.openGallery = function (e, t) {
            ...
            if ((void 0 === e && (e = this.settings.index), !this.lgOpened)) {
              ...
              this.zoomFromOrigin &&
                ...
                (o = $e(t, this.outer, a, l, this.currentImageSize))),
          ...
          (e.prototype.loadContent = function (e, t) {
            ...
            if (
              ...
              if (m) {
                ...
                C = Ne(o, x || "", g, this.settings.strings.playVideo, p);
                n.prepend(C);
              } else if (p) {
              ...
              this.$inner.on("touchend.lg", function (o) {
                if ("swipe" === e.touchAction) {
                  if (s) (s = !1), e.touchEnd(i, t, o);
                    ...
                    var r = ke(o.target);
                    e.isPosterElement(r) && e.LGel.trigger(Se);
                  }
          ...
          (e.prototype.enableDrag = function () {
            ...
            this.settings.enableDrag &&
              ...
              ke(window).on("mousemove.lg.global" + this.lgId, function (o) {
                s &&
                  e.lgOpened &&
                  ((n = !0),
              ...
              ke(window).on("mouseup.lg.global" + this.lgId, function (o) {
                if (e.lgOpened) {
                  var r = ke(o.target);
                  n
                    ? ((n = !1), e.touchEnd(i, t, o), e.LGel.trigger(Te))
                    : e.isPosterElement(r) && e.LGel.trigger(Se),
                    s &&
                      ((s = !1),
            ...
            return (
              setTimeout(function () {
                e.destroyModules(!0),
                  ...
                  ke(window).off(".lg.global" + e.lgId),
                  e.LGel.off(".lg"),
                  e.$container.remove();
              }, t),
              t
    ...
    var We = i(86),
      Ze = i(363);
    const Ue = document.querySelectorAll("[data-gallery]");
    Ue.length &&
      Ue.forEach((e) => {
        qe(e, {
          plugins: [We, Ze],
    ...
    const Ke = document.querySelector(".header"),
      Je = document.querySelector(".page");
    Ke.offsetHeight, Je.offsetHeight;
    window.addEventListener("scroll", () => {
      window.scrollY > 0
        ? Ke.classList.add("_fixed")
        : Ke.classList.remove("_fixed");
    }),
      (window.FLS = !1),
      (function (e) {
        let t = new Image();
