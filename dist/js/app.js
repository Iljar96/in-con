...
(() => {
  ...
  (() => {
    ...
    let Ue,
      Ke = document.getElementById("cases-galery"),
      Je = Ke.querySelectorAll(".cases__col-video"),
      Qe = [];
    if (Ke && Je.length > 0) {
      ...
      Ke.addEventListener("click", function (t) {
        t.target.closest(".cases__col-video") &&
          ((Ue = Ke.getElementsByClassName("swiper-slide-active")),
          (Ue = Number(Ue[0].getAttribute("data-swiper-slide-index"))),
          e.openGallery(Ue));
      });
    }
    ...
    document.body.addEventListener("click", (e) => {
      if (
        (e.target.closest(".articles__btn.btn--more") &&
          e.target.closest(".articles__btn.btn--more").remove(),
        e.target.closest(".form-block__nav-link"))
      ) {
    ...
    const et = document.querySelector(".header"),
      tt = document.querySelector(".page");
    et.offsetHeight, tt.offsetHeight;
    window.addEventListener("scroll", () => {
      window.scrollY > 0
        ? et.classList.add("_fixed")
        : et.classList.remove("_fixed");
    }),
      (window.FLS = !1),
      (function (e) {
        let t = new Image();
