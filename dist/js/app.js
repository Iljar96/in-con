...
(() => {
        ...
        e.exports = (function () {
          ...
          var t = "undefined" != typeof window,
            ...
            Z = function (e, t, i) {
              P(e, t.class_loading),
                T(e, m),
                i && (O(i, 1), _(t.callback_loading, e, i));
            },
            U = function (e, t, i) {
  ...
  (() => {
    ...
    const l = { inputMaskModule: null, selectModule: null },
      d = "Введите не менее 5 символов",
      c = "Поле может содержать символы a-z, 0-9 и подчеркивания",
      u = "Введите валидный email",
      h = "Введите номер телефона",
      p = (e) => {
    ...
    let g = {
      ...
      validateInput(e) {
        let t = 0;
        if ("email" === e.dataset.required || "email" === e.dataset.type)
          (e.value = e.value.replace(" ", "")),
            this.emailTest(e)
              ? ((e.dataset.error = u), this.addError(e), t++)
              : this.removeError(e);
        else if ("telegram" === e.dataset.type)
          (e.value = e.value.replace(" ", "")),
            this.nicknameTest(e)
              ? ((e.dataset.error = e.value.length > 4 ? c : d),
                this.addError(e),
                t++)
              : this.removeError(e);
        else if ("whatsapp" === e.dataset.type) {
          e.value.replace(/\D/g, "").length < 11
            ? ((e.dataset.error = h), this.addError(e), t++)
            : this.removeError(e);
        } else
      ...
      nicknameTest: (e) => !/^[a-zA-Z0-9_]{5,}$/.test(e.value),
      phoneNumberTest: (e) => !/^[0-9+]{5,}$/.test(e.value),
    };
    function m(e) {
      return (
        null !== e &&
    ...
    const L = {
      ...
      on: function (...e) {
        ...
        function o(e) {
          ...
          if ((n.indexOf(e) < 0 && n.unshift(e), T(t).is(i))) s.apply(t, n);
          else {
            const e = T(t).parents();
            for (let t = 0; t < e.length; t += 1)
              T(e[t]).is(i) && s.apply(e[t], n);
          }
        }
        function r(e) {
      ...
      is: function (e) {
        ...
        if ("string" == typeof e) {
          ...
          for (n = T(e), o = 0; o < n.length; o += 1) if (n[o] === s) return !0;
          return !1;
        }
        if (e === i) return s === i;
        if (e === t) return s === t;
        ...
        (t.clickedSlide = s),
          t.virtual && t.params.virtual.enabled
            ? (t.clickedIndex = parseInt(
                z(s).attr("data-swiper-slide-index"),
                10
              ))
            : (t.clickedIndex = n),
    ...
    const Y = {
      ...
      slideToClickedSlide: function () {
        ...
        if (t.loop) {
          ...
          (n = parseInt(z(e.clickedSlide).attr("data-swiper-slide-index"), 10)),
            t.centeredSlides
    ...
    const W = {
      loopCreate: function () {
        const e = this,
          ...
          n = s.children().length > 0 ? z(s.children()[0].parentNode) : s;
        ...
        if (i.loopFillGroupWithBlank) {
          ...
          if (e !== i.slidesPerGroup) {
            for (let s = 0; s < e; s += 1) {
              const e = z(t.createElement("div")).addClass(
        ...
        for (let e = 0; e < a.length; e += 1)
          n.append(z(a[e].cloneNode(!0)).addClass(i.slideDuplicateClass));
        for (let e = r.length - 1; e >= 0; e -= 1)
          n.prepend(z(r[e].cloneNode(!0)).addClass(i.slideDuplicateClass));
      },
      loopFix: function () {
        const e = this;
    ...
    function Z(e) {
      ...
      if (
        ...
        d.is(n.focusableElements) &&
          ...
          i.activeElement &&
            z(i.activeElement).is(n.focusableElements) &&
            i.activeElement !== d[0] &&
    ...
    function U(e) {
      ...
      if (!i.allowTouchMove)
        return (
          z(l.target).is(s.focusableElements) || (i.allowClick = !1),
          void (
            s.isTouched &&
            (Object.assign(o, {
              startX: c,
      ...
      if (
        ...
        z(l.target).is(s.focusableElements)
      )
      ...
      mount(e) {
        ...
        let n = (() => {
          if (e && e.shadowRoot && e.shadowRoot.querySelector) {
            const t = z(e.shadowRoot.querySelector(s()));
            return (t.children = (e) => i.children(e)), t;
          }
          return i.children ? i.children(s()) : z(i).children(s());
        })();
      ...
      i({
        ...
        s("click", (e, i) => {
          const { $nextEl: s, $prevEl: o } = t.navigation,
            r = i.target;
          if (t.params.navigation.hideOnClick && !z(r).is(o) && !z(r).is(s)) {
            if (
              t.pagination &&
              t.params.pagination &&
    ...
    function me(e) {
      ...
      function l() {
        ...
        function u(e) {
          return o ? z(e).attr("data-swiper-slide-index") : z(e).index();
        }
        if (
          ("auto" === d && (d = 0), r || (r = !0), t.params.watchSlidesProgress)
        )
          e.children(`.${i.slideVisibleClass}`).each((e) => {
            a(o ? z(e).attr("data-swiper-slide-index") : z(e).index());
          });
      ...
      function d() {
        ...
        const i = t.params.lazy.scrollingElement
            ? z(t.params.lazy.scrollingElement)
            : z(e),
          s = i[0] === e,
        ...
        return (
          ...
          (e.prototype.hideScrollbar = function () {
            if (this.shouldHideScrollbar()) {
              this.bodyPaddingRight = parseFloat(
                Ve("body").style().paddingRight
              );
              var e = document.documentElement.getBoundingClientRect(),
                t = window.innerWidth - e.width;
              Ve(document.body).css(
                "padding-right",
                t + this.bodyPaddingRight + "px"
              ),
                Ve(document.body).addClass("lg-overlay-open");
            }
          }),
          (e.prototype.resetScrollBar = function () {
            this.shouldHideScrollbar() &&
              ...
              Ve(document.body).removeClass("lg-overlay-open"));
          }),
          (e.prototype.openGallery = function (e, t) {
            ...
            if ((void 0 === e && (e = this.settings.index), !this.lgOpened)) {
              ...
              this.zoomFromOrigin &&
                ...
                (o = Fe(t, this.outer, a, l, this.currentImageSize))),
          ...
          (e.prototype.loadContent = function (e, t) {
            ...
            if (
              ...
              if (m) {
                ...
                C = We(o, x || "", g, this.settings.strings.playVideo, p);
                n.prepend(C);
              } else if (p) {
            ...
            "lg-slide" !== this.settings.mode &&
              ...
              setTimeout(function () {
                ...
                if (
                  ...
                  var a = Ve(i.target);
                  n.isPosterElement(a) && n.LGel.trigger(_e);
                }
              ...
              this.$inner.on("touchend.lg", function (o) {
                if ("swipe" === e.touchAction) {
                  if (s) (s = !1), e.touchEnd(i, t, o);
                    ...
                    var r = Ve(o.target);
                    e.isPosterElement(r) && e.LGel.trigger(_e);
                  }
          ...
          (e.prototype.closeGallery = function (e) {
            ...
            this.LGel.trigger($e),
              this.settings.resetScrollPosition &&
                !this.settings.hideScrollbar &&
                Ve(window).scrollTop(this.prevScrollTop);
            var i,
    ...
    let ot = document.getElementById("cases-galery");
    if (ot) {
      let e,
        t = ot.querySelectorAll(".cases__col-video"),
        i = [];
      if (t.length > 0) {
        for (let e = 0; e < t.length; e++) {
          const s = t[e];
        ...
        ot.addEventListener("click", function (t) {
          t.target.closest(".cases__col-video") &&
            ((e = ot.getElementsByClassName("swiper-slide-active")),
    ...
    (window.onload = function () {
      ...
      document.body.addEventListener("click", (e) => {
        const t = e.target;
        if (
          (t.closest(".btn--more") && t.remove(),
          t.closest(".form-block__nav-link"))
        ) {
        ...
        if (t.closest(".equipment__btn")) {
          t.closest(".equipment__btn").remove();
        }
        if (t.closest(".case-block__btn") && t.closest("[data-read-more]")) {
          const e = t.closest("[data-read-more]");
          (t.innerHTML = e.classList.contains("_opened")
            ? "Читать дальше"
            : "Скрыть"),
      ...
      document.querySelectorAll(".form-block__form").forEach((e) => {
        e.contacts;
      });
    }),
      (window.FLS = !1),
        ...
        if (i.length > 0) {
          ...
          function a(i) {
            ...
            if (s.hasAttribute("data-spoller") || s.closest("[data-spoller]")) {
              const n = s.hasAttribute("data-spoller")
                  ? s
      ...
      (function () {
        ...
        if (i.length > 0) {
          ...
          e.startsWith("tab-") && (s = e.replace("tab-", "").split("-")),
            i.forEach((e, t) => {
          ...
          const t = Array.from(i).filter(function (e, t, i) {
        ...
        function o(i) {
          ...
          if (s.closest("[data-tabs-title]")) {
            const n = s.closest("[data-tabs-title]"),
              o = n.closest("[data-tabs]");
            if (
              !n.classList.contains("_tab-active") &&
              !o.querySelectorAll("._slide").length
            ) {
              const i = o.querySelector("[data-tabs-title]._tab-active");
              i && i.classList.remove("_tab-active"),
                n.classList.add("_tab-active"),
                (function (i) {
                  const s = i.querySelectorAll("[data-tabs-title]"),
                    n = i.querySelectorAll("[data-tabs-item]"),
                    o = i.dataset.tabsIndex,
                    r = i.dataset.tabs ? i.dataset.tabs : null,
                    a = (function (e) {
      ...
      (function (e) {
        ...
        if (t.length)
          for (const e of t)
            "whatsapp" === e.contacts.dataset.type && p(e.contacts),
              e.addEventListener("submit", function (e) {
                i(e.target, e);
              });
        async function i(t, i) {
          if (0 === (e ? g.getErrors(t) : 0)) i.preventDefault();
          else {
            i.preventDefault();
